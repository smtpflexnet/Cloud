<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="CloudSupport.Customers" %>
   ...
   <tr style='mso-yfti-irow:3;mso-yfti-lastrow:yes'>
    ...
    <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 align=left
     ...
     <tr style='mso-yfti-irow:2'>
      ...
      100.0%;mso-style-textfill-fill-colortransforms:lumm=50000'><%= ServiceImpactedHeader %></span><span style='color:#1F497D;mso-themecolor:text2'><o:p></o:p></span></i></p>
      </td>
     </tr>
     <tr style='mso-yfti-irow:3'>
	  ...
	  <o:p><%= ServiceImpactedBody %></o:p></span></i></p>
      </td>
     </tr>
